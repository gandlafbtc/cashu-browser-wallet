...
import type { NutstashDB } from '$lib/db/model.js';
import { key } from '$lib/stores/session/key.js';
import type { StoreNames } from 'idb';
import { get } from 'svelte/store';
import * as encryption from '$lib/actions/encryption.js';
import type { EncryptedStore } from '$lib/db/models/types.js';
...
export const createEncryptionHelper = <T>(
	dbStoreName: StoreNames<NutstashDB>
): EncryptionHelper<T> => {
